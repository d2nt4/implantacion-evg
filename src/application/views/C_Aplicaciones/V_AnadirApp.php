		...
		<div id="principal" class="container-fluid">
			<div class="row">
				<header class="col-12">
					...
					<div class="col-6">
						<?php echo "<button onclick=\"location.href ='" . base_url() . "C_GestionEVG/'\" id=\"icon-grid\" class=\"btn mr-2\"><i class=\"fas fa-th\" data-toggle=\"popover\" data-content=\"Grid Aplicaciones\"></i></button>"; ?>
						<?php
