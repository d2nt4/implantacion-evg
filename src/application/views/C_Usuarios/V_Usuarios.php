			...
			<div class="row">
				...
				<div class="general">
					<div id="principal" class="container-fluid">
						...
						<?php echo "<button onclick=\"location.href ='" . base_url() . "C_GestionEVG/anadirUsuarioForm'\" class=\"btn btn-success\"><i class=\"fas fa-plus-square\"></i></button>"; ?>
						<?php echo "<button onclick=\"location.href ='" . base_url() . "C_GestionEVG/importarUsuariosForm'\" class=\"btn btn-warning\"><i class=\"fas fa-file-import\"></i></button>"; ?>
