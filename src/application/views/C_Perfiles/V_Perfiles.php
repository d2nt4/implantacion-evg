		...
		<div id="principal" class="container-fluid">
			...
			<div class="row">
				...
				<div class="general">
					...
					<?php echo "<button onclick=\"location.href ='" . base_url() . "C_GestionEVG/anadirPerfilForm'\" class=\"btn btn-success\" data-toggle=\"popover\" data-content=\"Añadir Perfil\"><i class=\"fas fa-plus-square\"></i></button>"; ?>
							...
							foreach($this->listaPerfiles as $indice => $valor)
								echo
									"
										<div class=\"fila\">
											<h3>".$valor."</h3>
											<button onclick=\"location.href ='" . base_url() . "C_GestionEVG/usuariosPerfil/".$indice."'\" class=\"btn btn-primary\" data-toggle=\"popover\" data-content=\"Usuarios Perfil\"><i class=\"fas fa-user-circle\"></i></button>
											<button onclick=\"location.href ='" . base_url() . "C_GestionEVG/modificarPerfilForm/".$indice."'\" class=\"btn btn-warning\" data-toggle=\"popover\" data-content=\"Editar Perfil\"><i class=\"fas fa-edit\"></i></button>
